...
<div class="header">
    ...
    <div class="back-btn-container">
        <button class="back-btn" onclick="window.location.href='enter_book.php'">back</button>
    </div>
</div>
...
function calculateOverdue() {
    ...
    let overdueField = document.getElementById("dateoverdue"); 

    if (!isNaN(dueDate.getTime()) && !isNaN(returnDate.getTime())) { 
        let timeDiff = returnDate - dueDate;
        let daysOverdue = Math.max(0, Math.ceil(timeDiff / (1000 * 60 * 60 * 24))); 
